...
const GridBackground = forwardRef<HTMLDivElement, { children: ReactNode }>(
  ({ children }, ref) => {
    return (
      <div
        ref={ref}
        className='h-[calc(100dvh-4.5rem)] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative font-robot overflow-hidden lg:p-6 md:p-4 p-2 pb-6'
      >
